...
def sky_median_sig_clip(input_arr, sig_fract, percent_fract, max_iter=100):
	...
	@param input_arr: image FITS array
...
def linear(inputArray, scale_min=None, scale_max=None):
	...
	@param inputArray: image FITS array
	@type scale_min: float
	@param scale_min: minimum FITS value
	@type scale_max: float
	@param scale_max: maximum FITS value
	@rtype: numpy array
	@return: image FITS array
